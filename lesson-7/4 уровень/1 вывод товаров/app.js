...
function clickHandler(event) {
    ...
    let btnData = event.target.getAttribute("data-type");
    showCategory(btnData);
};
...
function getProductMarkup(product) {
    for (var i in product) {
        ...
        let productUrl = product[i].imageUrl;
        divProducts.innerHTML = divProducts.innerHTML + `<div class="product">
            <div>${productName}</div>
